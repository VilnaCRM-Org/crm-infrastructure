...
with Diagram(
    "\nCRM Infrastructure Terraform pipeline Production Design VilnaCRM",
    show=False,
    filename="../../img/prod/crm_infra_pipeline_design",
):
    gh = Github("Github Repository")
    codepipe = Codepipeline("AWS CodePipeline")
    s3 = SimpleStorageServiceS3("AWS S3 \n Artifact Bucket")
    website_infra_codepipeline = Cluster("CRM Infra CodePipeline")
