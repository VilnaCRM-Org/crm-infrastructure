data "aws_iam_policy_document" "s3_policy_doc" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:s3:::${var.ci_cd_project_name}-logging-bucket/*",
      "arn:aws:s3:::${var.crm_project_name}-codepipeline-artifacts-bucket",
      "arn:aws:s3:::${var.crm_project_name}-codepipeline-artifacts-bucket/*",
      "arn:aws:s3:::${var.ci_cd_project_name}-codepipeline-artifacts-bucket",
      "arn:aws:s3:::${var.ci_cd_project_name}-codepipeline-artifacts-bucket/*",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-codepipeline-artifacts-bucket",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-codepipeline-artifacts-bucket/*",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-lhci-reports-bucket",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-lhci-reports-bucket/*",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-test-reports-bucket",
      "arn:aws:s3:::${var.ci_cd_crm_project_name}-test-reports-bucket/*",
      "arn:aws:s3:::${var.project_name}-access-logs-${var.environment}",
      "arn:aws:s3:::${var.project_name}-access-logs-${var.environment}/*",
      "arn:aws:s3:::sandbox-crm-${var.environment}-codepipeline-artifacts-bucket",
      "arn:aws:s3:::sandbox-crm-${var.environment}-codepipeline-artifacts-bucket/*",
