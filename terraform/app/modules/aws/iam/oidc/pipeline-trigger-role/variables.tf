...
variable "github_repo" {
  description = "Name of the GitHub repository without owner prefix (e.g., 'crm-infrastructure')"
  type        = string
}

variable "crm_repo" {
  description = "Name of the GitHub repository without owner prefix (e.g., 'crm')"
  type        = string
}
