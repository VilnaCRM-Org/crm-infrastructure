...
variable "enable_cloudwatch_alarms" {
  description = "Whether to create CloudWatch alarms for the crm bucket"
  type        = bool
}

variable "enable_access_logging" {
  description = "Whether to enable S3 access logging for the CRM buckets"
  type        = bool
}

variable "noncurrent_version_expiration_days" {
  description = "Retention time for noncurrent CRM bucket object versions"
  type        = number
}
