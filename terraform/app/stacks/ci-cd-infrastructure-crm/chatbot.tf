module "chatbot_codepipelines" {
  ...
  sns_topic_arns = [
    module.crm_infra_codepipeline.sns_topic_arn,
    module.ci_cd_infra_codepipeline.sns_topic_arn,
    module.ci_cd_crm_codepipeline.codepipeline_sns_topic_arn,
...
module "chatbot_reports" {
  ...
  sns_topic_arns = [
    module.ci_cd_crm_codepipeline.reports_sns_topic_arn
  ]
