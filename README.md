...
![CRM Infrastructure Terraform pipeline Production Design VilnaCRM](/diagrams/img/prod/crm_infra_pipeline_design.png)

![CI/CD CRM pipeline Production Design VilnaCRM](/diagrams/img/prod/ci_cd_crm_pipeline_design.png)

#### Test Environment

![CI/CD Infrastructure Terraform pipeline Test Design VilnaCRM](/diagrams/img/test/ci_cd_infra_pipeline_design.png)

![СRM Infrastructure Terraform pipeline Test Design VilnaCRM](/diagrams/img/test/crm_infra_pipeline_design.png)

![CI/CD CRM pipeline Test Design VilnaCRM](/diagrams/img/test/ci_cd_crm_pipeline_design.png)
...
- **TF_VAR_CI_CD_ALERTS_SLACK_CHANNEL_ID** - ID of Slack channel where the CodePipeline alerts will be posted.
- **TF_VAR_CRM_ALERTS_SLACK_CHANNEL_ID** - ID of Slack channel where the Crm alerts will be posted.
- **TF_VAR_REPORT_SLACK_CHANNEL_ID** - ID of Slack channel where the reports of the crm tests will be posted.
...
After you deployed you can create the crm infrastructure itself using.
- `terraspace all up`

Alternatively, you can use the following command to bring up the entire infrastructure stack:

- `make terraspace-up stack=ci-cd-infrastructure-crm`

This command simplifies the process by targeting the ci-cd-infrastructure-crm stack directly.
...
```bash
  ...
  trigger-pipeline:              Trigger AWS CodePipeline. Variables: pipeline. Example: make trigger-pipeline pipeline=ci-cd-infra-crm-test-pipeline
```

## Documentation

Start reading at the [GitHub wiki](https://github.com/VilnaCRM-Org/crm-infrastructure/wiki). If you're having trouble, head for [the troubleshooting guide](https://github.com/VilnaCRM-Org/crm-infrastructure/wiki/Troubleshooting) as it's frequently updated.

If the documentation doesn't cover what you need, search the [many questions on Stack Overflow](http://stackoverflow.com/questions/tagged/vilnacrm), and before you ask a question, [read the troubleshooting guide](https://github.com/VilnaCRM-Org/crm-infrastructure/wiki/Troubleshooting).
