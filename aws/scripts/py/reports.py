...
def get_environment_variables():
    return {
        ...
        "git_repository_last_commit_sha": os.environ[
            "CRM_GIT_REPOSITORY_LAST_COMMIT_SHA"
        ],
        "git_repository_link": os.environ["CRM_GIT_REPOSITORY_LINK"],
        "git_author": os.environ["CRM_GIT_REPOSITORY_LAST_COMMIT_AUTHOR"],
        "git_name": os.environ["CRM_GIT_REPOSITORY_LAST_COMMIT_NAME"],
